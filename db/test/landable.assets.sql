BEGIN;
  ...
  SELECT col_not_null('landable', 'assets', 'filename', 'filename not null');
  ...
  SELECT indexes_are('landable', 'assets', ARRAY['assets_pkey', 'landable_assets__u_data', 'landable_assets__u_md5sum', 'landable_assets__author_id', 'landable_assets__u_lower_filename'], 'Assets has indexes');
