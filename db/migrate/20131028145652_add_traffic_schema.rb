class AddTrafficSchema < Landable::Migration
  ...
  def up
    ...
    execute "CREATE SCHEMA #{Landable.configuration.schema_prefix}landable_traffic;"

    with_options schema: "#{Landable.configuration.schema_prefix}landable_traffic" do |t|
      # Query Params
    ...
    execute <<-SQL
      SET search_path TO #{Landable.configuration.schema_prefix}landable_traffic,public;
      ...
      CREATE TABLE page_views (
        ...
        , page_revision_id   UUID                    REFERENCES #{Landable.configuration.schema_prefix}landable.page_revisions
        , request_id         UUID
