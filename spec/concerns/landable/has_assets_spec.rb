  ...
  describe HasAssets do
    ...
    describe '#assets_join_table_name' do
      it 'should generate the correct join_table, and then apologize for doing so' do
        Page.send(:assets_join_table_name).should == 'dummy_landable.page_assets'
        PageRevision.send(:assets_join_table_name).should == 'dummy_landable.page_revision_assets'
        Theme.send(:assets_join_table_name).should == 'dummy_landable.theme_assets'
      end
    end
